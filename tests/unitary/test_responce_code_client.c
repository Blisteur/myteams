...
TestSuite(responce_code_client, .init = redirect_all_stdout);


Test(responce_code_client, test_reponse_code_100)
{
    ...
    cr_assert_stderr_eq_str("New team created event id test: 04794982-5fea-4477-b50e-c5a0134a9e8e (description)\n", "");
    free(client);
    free(json);
}

Test(responce_code_client, test_reponse_code_101)
{
    client_t *client = malloc(sizeof(client_t));
    receive_json_t *json = malloc(sizeof(receive_json_t));
    ...
    cr_assert_stderr_eq_str("New channel created event id test: 04794982-5fea-4477-b50e-c5a0134a9e8e (description)\n", "");
    free(client);
    free(json);
}

Test(responce_code_client, test_reponse_code_102)
{
    client_t *client = malloc(sizeof(client_t));
    receive_json_t *json = malloc(sizeof(receive_json_t));
    ...
    //cr_assert_stderr_eq_str("New thread created event id 04794982-5fea-4441-b50e-c5a0134a9e8e by (04794982-5fea-4442-b50e-c5a0134a9e8e) at Thu Apr 18 04:45:55 2019: test (test)\n", "");
    free(client);
    free(json);
}

Test(responce_code_client, test_reponse_code_103)
{
    client_t *client = malloc(sizeof(client_t));
    receive_json_t *json = malloc(sizeof(receive_json_t));
    ...
    cr_assert_stderr_eq_str("New reply from 04794982-5fea-4123-b50e-c5a0134a9e8e in thread 04794982-5fea-4477-b50e-c5a0134a9e8e of team 04794982-5fea-8888-b50e-c5a0134a9e8e: [test]\n", "");
    free(client);
    free(json);
}

Test(responce_code_client, test_reponse_code_201)
{
    client_t *client = malloc(sizeof(client_t));
    receive_json_t *json = malloc(sizeof(receive_json_t));
    ...
    cr_assert_stderr_eq_str("New private message from 04794982-5fea-8888-b50e-c5a0134a9e8e: [test]\n", "");
    free(client);
    free(json);
}

Test(responce_code_client, test_reponse_code_202)
{
    client_t *client = malloc(sizeof(client_t));
    receive_json_t *json = malloc(sizeof(receive_json_t));
    ...
    cr_assert_stderr_eq_str("Client 04794982-5fea-8888-b50e-c5a0134a9e8e logged in with login test\n", "");
    free(client);
    free(json);
}

Test(responce_code_client, test_reponse_code_203)
{
    client_t *client = malloc(sizeof(client_t));
    receive_json_t *json = malloc(sizeof(receive_json_t));
    ...
    cr_assert_stderr_eq_str("Client 04794982-5fea-8888-b50e-c5a0134a9e8e logged out with login test\n", "");
    free(client);
    free(json);
}

Test(responce_code_client, test_reponse_code_210)
{
    client_t *client = malloc(sizeof(client_t));
    receive_json_t *json = malloc(sizeof(receive_json_t));
    ...
    cr_assert_stderr_eq_str("User \"test\" (04794982-5fea-4477-b50e-c5a0134a9e8e): 1\n", "");
    free(client);
    free(json);
}

Test(responce_code_client, test_reponse_code_211)
{
    client_t *client = malloc(sizeof(client_t));
    receive_json_t *json = malloc(sizeof(receive_json_t));
...
Test(responce_code_client, test_reponse_code_212)
{
    client_t *client = malloc(sizeof(client_t));
    receive_json_t *json = malloc(sizeof(receive_json_t));
...
Test(responce_code_client, test_reponse_code_219)
{
    client_t *client = malloc(sizeof(client_t));
    receive_json_t *json = malloc(sizeof(receive_json_t));
...
Test(responce_code_client, test_reponse_code_220)
{
    client_t *client = malloc(sizeof(client_t));
    receive_json_t *json = malloc(sizeof(receive_json_t));
...
Test(responce_code_client, test_reponse_code_221)
{
    client_t *client = malloc(sizeof(client_t));
    receive_json_t *json = malloc(sizeof(receive_json_t));
...
Test(responce_code_client, test_reponse_code_222)
{
    client_t *client = malloc(sizeof(client_t));
    receive_json_t *json = malloc(sizeof(receive_json_t));
...
Test(responce_code_client, test_reponse_code_223)
{
    client_t *client = malloc(sizeof(client_t));
    receive_json_t *json = malloc(sizeof(receive_json_t));
...
Test(responce_code_client, test_reponse_code_224)
{
    client_t *client = malloc(sizeof(client_t));
    receive_json_t *json = malloc(sizeof(receive_json_t));
...
Test(responce_code_client, test_reponse_code_225)
{
    client_t *client = malloc(sizeof(client_t));
    receive_json_t *json = malloc(sizeof(receive_json_t));
...
Test(responce_code_client, test_reponse_code_226)
{
    client_t *client = malloc(sizeof(client_t));
    receive_json_t *json = malloc(sizeof(receive_json_t));
...
Test(responce_code_client, test_reponse_code_227)
{
    client_t *client = malloc(sizeof(client_t));
    receive_json_t *json = malloc(sizeof(receive_json_t));
...
Test(responce_code_client, test_reponse_code_228)
{
    client_t *client = malloc(sizeof(client_t));
    receive_json_t *json = malloc(sizeof(receive_json_t));
...
Test(responce_code_client, test_reponse_code_229)
{
    client_t *client = malloc(sizeof(client_t));
    receive_json_t *json = malloc(sizeof(receive_json_t));
...
Test(responce_code_client, test_reponse_code_230)
{
    client_t *client = malloc(sizeof(client_t));
    receive_json_t *json = malloc(sizeof(receive_json_t));
...
Test(responce_code_client, test_reponse_code_231)
{
    client_t *client = malloc(sizeof(client_t));
    receive_json_t *json = malloc(sizeof(receive_json_t));
...
Test(responce_code_client, test_reponse_code_232)
{
    client_t *client = malloc(sizeof(client_t));
    receive_json_t *json = malloc(sizeof(receive_json_t));
...
Test(responce_code_client, test_reponse_code_233)
{
    client_t *client = malloc(sizeof(client_t));
    receive_json_t *json = malloc(sizeof(receive_json_t));
...
Test(responce_code_client, test_reponse_code_401)
{
    client_t *client = malloc(sizeof(client_t));
    receive_json_t *json = malloc(sizeof(receive_json_t));
...
Test(responce_code_client, test_reponse_code_403)
{
    client_t *client = malloc(sizeof(client_t));
    receive_json_t *json = malloc(sizeof(receive_json_t));
...
Test(responce_code_client, test_reponse_code_410)
{
    client_t *client = malloc(sizeof(client_t));
    receive_json_t *json = malloc(sizeof(receive_json_t));
    ...
    cr_assert_stderr_eq_str("Unknown user 04794982-5fea-4477-b50e-c5a0134a9e8e\n", "");
    free(client);
    free(json);
}

Test(responce_code_client, test_reponse_code_411)
{
    client_t *client = malloc(sizeof(client_t));
    receive_json_t *json = malloc(sizeof(receive_json_t));
    ...
    cr_assert_stderr_eq_str("Unknown team 04794982-5fea-4477-b50e-c5a0134a9e8e\n", "");
    free(client);
    free(json);
}

Test(responce_code_client, test_reponse_code_412)
{
    client_t *client = malloc(sizeof(client_t));
    receive_json_t *json = malloc(sizeof(receive_json_t));
    ...
    cr_assert_stderr_eq_str("Unknown channel 04794982-5fea-4477-b50e-c5a0134a9e8e\n", "");
    free(client);
    free(json);
}

Test(responce_code_client, test_reponse_code_413)
{
    client_t *client = malloc(sizeof(client_t));
    receive_json_t *json = malloc(sizeof(receive_json_t));
    ...
    cr_assert_stderr_eq_str("Unknown thread 04794982-5fea-4477-b50e-c5a0134a9e8e\n", "");
    free(client);
    free(json);
}


Test(responce_code_client, test_reponse_code_414)
{
    client_t *client = malloc(sizeof(client_t));
    receive_json_t *json = malloc(sizeof(receive_json_t));
